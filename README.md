```mermaid
flowchart TD
    A[Inicio] --> B[Mostrar menu principal]
    ...
    E5 --> E6[Seleccionar metodo de pago (Yape, Plin, Efectivo, Tarjeta)]
    E6 --> E7[Seleccionar tipo de comprobante (Boleta o Factura)]
    E7 --> E8[Calcular total a pagar]
    E8 --> E9[Generar ID unico del pedido]
    ...
    G2 --> G3{Existe?}
    G3 -->|Si| G4[Mostrar informacion del pedido]
